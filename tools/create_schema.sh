...
CREATE TABLE tls201_appln (
  ...
  int_phase char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  reg_phase char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  nat_phase char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
